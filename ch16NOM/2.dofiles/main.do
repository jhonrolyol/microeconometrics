...
* Set working directory
    global root "D:\master\microeconometrics\ch16NOM"
    cd          "$root"
    cap !mkdir 1.slides
    cap !mkdir 2.dofiles
...
* Solution of the exercises
    ...
    do "${dofiles}/exercise7.do"
    do "${dofiles}/exercise8.do"
    do "${dofiles}/exercise9.do"
    do "${dofiles}/exercise10.do"
    do "${dofiles}/exercise11.do"		
